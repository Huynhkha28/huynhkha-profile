...
function App() {
  ...
  const handleClickGoToSection = (targetId) => {
    ...
    <>
      ...
      <section className='w-full h-fit' id="aboutme">
        <div className='flex flex-col sm:flex-row '>
          <div alt='avt' className='avt bg-center bg-cover bg-no-repeat sm:w-[400px] sm:h-[400px] bg-gradient-to-r from-transparent to-white rounded-full mx-auto sm:mx-15 md:mx-20' />
          <div className='flex flex-col justify-center items-center mt-4 sm:w-8/12'>
      ...
      <section className='h-fit w-full'>
        ...
        <div className='w-full pt-4 flex justify-center'>
          <ul className='flex md:flex-row flex-col '>
            <li className='border-2  sm:h-[250px] sm:max-w-4/12 text-center text-base sm:text-lg sm:mx-6 mt-6 px-3 hover:shadow-lg hover:shadow-gray hover:cursor-pointer rounded-[30px]'>
              ...
              <p className='text-start text-sm sm:text-base pl-2'>Link:<a href="https://github.com/Huynhkha28/project_IS207">https://github.com/Huynhkha28/project_IS207</a> </p>
            </li>
            <li className='border-2  sm:h-[250px] sm:w-4/12 text-center text-lg sm:mx-6 mt-6 px-3 hover:shadow-lg hover:shadow-gray hover:cursor-pointer rounded-[30px]'>
              ...
              <p className='text-start text-sm sm:text-base pl-2'>Link:<a href="https://github.com/Huynhkha28/project_fordev">https://github.com/Huynhkha28/project_fordev</a> </p>
            </li>
            <li className='border-2  sm:h-[250px] sm:w-4/12 text-center text-lg sm:mx-6 mt-6 px-3 hover:shadow-lg hover:shadow-gray hover:cursor-pointer rounded-[30px]'>
              ...
              <p className='text-start text-sm sm:text-base pl-2'>Link:<a href="https://github.com/Huynhkha28/project_fordev">https://github.com/Huynhkha28/myprofile</a></p>
            </li>
          </ul>
        </div>
      </section>
        ...
        <div className='font-semibold text-3xl sm:text-6xl text-stone-500 w-full flex flex-col mt-20 justify-center items-center sm:mx-20' id='contact'>
          ...
          <div className='flex mx-10 mt-10'>
            ...
            <div className='flex flex-col pl-5'>
              ...
              <a href='https://github.com/Huynhkha28' className=' text-xl  sm:text-2xl mt-2'>https://github.com/Huynhkha28</a>
            </div>
